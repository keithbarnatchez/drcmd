...
# --- plot.drcmd rendering tests ---

test_that("plot.drcmd renders PO plot without error", {
  expect_silent(plot(results, type = "PO"))
})

test_that("plot.drcmd renders IC plot without error", {
  expect_silent(plot(results, type = "IC"))
})

test_that("plot.drcmd renders g_hat plot without error", {
  expect_silent(plot(results, type = "g_hat"))
})

test_that("plot.drcmd renders r_hat plot without error", {
  expect_silent(plot(results, type = "r_hat"))
})
